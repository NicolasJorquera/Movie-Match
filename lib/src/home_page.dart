...
class _HomePageState extends State<HomePage> {
  ...
  List<bool> platformsSelected = List<bool>.generate(10, (index) => false);
                              ...
                              return GestureDetector(
                                ...
                                child: Card(
                                  ...
                                  child: Image.asset(
                                    ...
                                    fit: BoxFit.cover,
                                    color: platformsSelected.every(
                                                (element) => element == true) ||
                                            (platformsSelected.contains(true) &&
                                                !platformsSelected[index])
                            ...
                            child: TextButton(
                              onPressed: () {
                                setState(() {
                                  // allPlatformsSelected = !allPlatformsSelected;
                                  platformsSelected = platformsSelected
                                      .map<bool>((v) => platformsSelected.every(
